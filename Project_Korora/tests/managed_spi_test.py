...
class TestManagedSpi(TestCase):
    def test_acquire(self):
        ...
        # would just use tasko.add_task() and tasko.run() but for test let's manually
        # step it through loop.run()
